                                            ...
                                            <motion.div key={link.name} variants={mobileItemVariants}>
                                                ...
                                                <AnimatePresence>
                                                    {isMobileServicesOpen && (
                                                        ...
                                                        >
                                                            {/* 1-column layout for mobile services to allow subServices expansion */}
                                                            <div className="mt-2 flex flex-col gap-1.5 px-1">
                                                                {services.map((service, i) => {
                                                                    const Icon = service.icon;
                                                                    const isExpandedUrl = expandedMobileService === service.name;
                                                                    return (
                                                                        <motion.div
                                                                            key={service.name}
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {service.subServices ? (
                                                                                    <motion.div animate={{ rotate: isExpandedUrl ? 180 : 0 }} transition={{ duration: 0.2 }}>
                                                                                        <HiChevronDown size={14} className="text-primary-teal flex-shrink-0" />
                                                                                    </motion.div>
                                                                                ) : (
                                                                                        ...
                                                                                        >
                                                                                            {service.subServices.map((sub, idx) => (
                                                                                                <motion.div
                                                                                                    ...
                                                                                                    className="group/subm flex w-full items-center justify-between text-[11.5px] font-medium px-3 py-2.5 rounded-lg bg-white shadow-sm border border-gray-100 text-text-body active:bg-primary-light/30 transition-colors duration-150 cursor-pointer will-change-[opacity,transform]"
                                                                                                >
                                                                                                    <span className="flex items-center gap-2">
                                                                                                        <div className={`w-1.5 h-1.5 rounded-full bg-gray-300 group-hover/subm:bg-primary-teal transition-colors duration-200`} />
                                                                                                        {sub}
                                                                                                    </span>
