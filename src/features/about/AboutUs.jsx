...
const stats = [
    { value: '20+', label: 'Active Clients', suffix: '+', prefix: '', endValue: 3400 },
    { value: '115+', label: 'Projects Done', suffix: '', prefix: '', endValue: 85 },
    { value: '₹30L+', label: 'Ad Spend Managed', suffix: '', prefix: '', endValue: 180 },
    { value: '90+', label: 'Successful Campaigns', suffix: '', prefix: '', endValue: 8500 },
];
